...
Input: Metadata: authors Lewis et al.; year 2020; title RAG; arXiv URL.

Output: Lewis et al. (2020) is a foundational citation because it defines RAG. Use only the supplied arXiv URL; do not invent a DOI.
...
- **Yarats, D., Fergus, R., Lazaric, A., & Pinto, L. (2021).** *Mastering Visual Continuous Control: Improved Data-Augmented Reinforcement Learning.* arXiv preprint 2107.09645v1. https://arxiv.org/abs/2107.09645v1

This paper introduces DrQ-v2, a model-free reinforcement learning algorithm for visual continuous control, which builds on DrQ and introduces several improvements to achieve state-of-the-art results on the DeepMind Control Suite.
