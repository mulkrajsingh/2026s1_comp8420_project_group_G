...
function stopActiveRequest() {
  ...
  // Abort the in-flight fetch immediately so the UI responds right away.
  if (controller) controller.abort();
  // Notify the backend to stop generation; fire-and-forget so a slow or
  // failing cancel response never blocks the UI from showing "Stopped."
  if (requestId) {
